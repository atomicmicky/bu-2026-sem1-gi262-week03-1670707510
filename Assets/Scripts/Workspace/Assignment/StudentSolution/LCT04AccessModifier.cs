...
namespace Assignment.StudentSolution.LCT04
{
    public class Animal
    {
        ...
        /// จากการออกแบบนี้ จะทำให้การกำหนดค่าให้กับ specie จะต้องทำผ่าน class ที่สืบทอด Animalเท่านั้น
    ...
    public class Dog : Animal
    {
        public Dog(string name)
        {
            ...
            // ทำให้ใช้งานได้แค่นใน class ที่ประกาศ health ไว้เท่านั้น ซึ่งก็คือ class Animal
            // this.health = 100; ==> COMPILE ERROR
            //this.health = name; ได้เนื่องจาก health เป็น private
        }
    }
